...
type MigrationAlertListOptions struct {
	...
	MetricType string `help:"Migration alert metric type" choices:"cpu.usage_active|mem.used_percent"`
}
...
type MigrationAlertCreateOptions struct {
	...
	METRIC      string   `help:"Metric type" choices:"cpu.usage_active.gt|mem.used_percent.gt"`
