...
// SHostcluster is an autogenerated struct via yunion.io/x/onecloud/pkg/compute/models.SHostcluster.
...
// SCluster is an autogenerated struct via yunion.io/x/onecloud/pkg/compute/models.SCluster.
...
// SClusterJointsBase is an autogenerated struct via yunion.io/x/onecloud/pkg/compute/models.SClusterJointsBase.
type SClusterJointsBase struct {
	apis.SJointResourceBase
	ClusterId string `json:"cluster_id"`
}

// SClusterActivity is an autogenerated struct via yunion.io/x/onecloud/pkg/compute/models.SClusterActivity.
type SClusterActivity struct {
	apis.SStatusStandaloneResourceBase
	SClusterResourceBase
	MigrateNumber int `json:"migrate_number"`
	// 起因描述
	TriggerDesc string `json:"trigger_desc"`
	Strategy     string `json:"strategy"`
	// 行为描述
